...
func Test_ErrDatabaseConfigNotFound(t *testing.T) {
	t.Run("creation", func(t *testing.T) {
		...
		if e := errDatabaseConfigNotFound(arg); !errors.Is(e, err.ErrDatabaseConfigNotFound) {
...
func Test_ErrUnknownDatabaseDialect(t *testing.T) {
	t.Run("creation", func(t *testing.T) {
		...
		if e := errUnknownDatabaseDialect(arg); !errors.Is(e, err.ErrUnknownDatabaseDialect) {
