...
func (m *MockConfigurer) Has(path string) bool {
	m.ctrl.T.Helper()
...
func (mr *MockConfigurerRecorder) Has(path interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Has", reflect.TypeOf((*MockConfigurer)(nil).Has), path)
}
