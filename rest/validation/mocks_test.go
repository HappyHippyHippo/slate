...
// MockFieldError is a mocked instance of FieldError interface.
...
// MockTranslator is a mocked instance of Translator interface.
...
// MockParser is a mocked instance of IParser interface.
...
func (m *MockParser) Parse(val interface{}, errs validator.ValidationErrors) (*envelope.Envelope, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Parse", val, errs)
	ret0, _ := ret[0].(*envelope.Envelope)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
