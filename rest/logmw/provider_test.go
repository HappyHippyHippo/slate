...
func Test_Provider_Register(t *testing.T) {
	...
	t.Run("error retrieving logger when retrieving the generator", func(t *testing.T) {
		...
		_ = container.Service(log.ID, func() (*log.Log, error) { return nil, expected })
	...
	t.Run("retrieving the middleware generator", func(t *testing.T) {
		...
		_ = container.Service("request.reader", func() RequestReader {
			return func(_ *gin.Context) (log.Context, error) {
				return log.Context{}, nil
			}
		})
		_ = container.Service("response.reader", func() ResponseReader {
			return func(_ *gin.Context, _ Writer, _ int) (log.Context, error) {
				return log.Context{}, nil
			}
		})
