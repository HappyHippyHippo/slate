...
func (m *MockLogger) AddStream(id string, stream slog.IStream) error {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Broadcast(level slog.Level, msg string, ctx map[string]interface{}) error {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Signal(channel string, level slog.Level, msg string, ctx map[string]interface{}) error {
	m.ctrl.T.Helper()
...
func (m *MockLogger) Stream(id string) slog.IStream {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Stream", id)
	ret0, _ := ret[0].(slog.IStream)
	return ret0
}
