...
var (
	...
	ServiceIDConfigPath = env.String(EnvID+"_SERVICE_ID_CONFIG_PATH", "slate.api.rest.service.id")
	...
	FormatAcceptListConfigPath = env.String(EnvID+"_FORMAT_ACCEPT_LIST_CONFIG_PATH", "slate.api.rest.accept")
	...
	EndpointIDConfigPathFormat = env.String(EnvID+"_ENDPOINT_ID_CONFIG_PATH_FORMAT", "slate.api.rest.endpoints.%s.id")
