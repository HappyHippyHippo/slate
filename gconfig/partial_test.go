...
func Test_Partial_Clone(t *testing.T) {
	...
	t.Run("recursive cloning", func(t *testing.T) {
		p := Partial{"field": Partial{"field": "value"}}
		expected := Partial{"field": Partial{"field": "value"}}
		c := p.Clone()
		p["extra"] = "value"
		p["field"].(Partial)["extra"] = "value"
	...
	t.Run("recursive cloning with lists", func(t *testing.T) {
		p := Partial{"field": []interface{}{Partial{"field": "value"}}}
		expected := Partial{"field": []interface{}{Partial{"field": "value"}}}
		c := p.Clone()
		p["extra"] = "value"
		p["field"].([]interface{})[0].(Partial)["extra"] = "value"
	...
	t.Run("recursive cloning with multi-level lists", func(t *testing.T) {
		p := Partial{"field": []interface{}{[]interface{}{Partial{"field": "value"}}}}
		expected := Partial{"field": []interface{}{[]interface{}{Partial{"field": "value"}}}}
		c := p.Clone()
		p["extra"] = "value"
		p["field"].([]interface{})[0].([]interface{})[0].(Partial)["extra"] = "value"
...
func Test_Partial_Get(t *testing.T) {
	t.Run("retrieve a value of a existent path", func(t *testing.T) {
		...
		for _, scenario := range scenarios {
			if check, err := scenario.partial.Get(scenario.search); err != nil {
				t.Errorf("returned the unexpected error (%v) when retrieving (%v)", err, scenario.search)
	...
	t.Run("return nil if a path don't exists", func(t *testing.T) {
		...
		for _, scenario := range scenarios {
			check, err := scenario.partial.Get(scenario.search)
			switch {
			case err == nil:
				t.Error("didn't returned the expected error")
			case !errors.Is(err, gerror.ErrConfigPathNotFound):
				t.Errorf("returned error was not a config path not found error : %v", err)
			case check != nil:
	...
	t.Run("return nil if the node actually stores nil", func(t *testing.T) {
		data := Partial{"node1": nil, "node2": "value2"}

		if check, err := data.Get("node1", "default_value"); err != nil {
	...
	t.Run("return the default value if a path don't exists", func(t *testing.T) {
		...
		def := "default_value"
		for _, scenario := range scenarios {
			if check, err := scenario.partial.Get(scenario.search, def); err != nil {
				t.Errorf("returned the unexpected error : %v", err)
			} else if check != def {
...
func Test_Partial_Bool(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.Bool(path, false); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
		} else if !check {
	...
	t.Run("return conversion error if not storing a bool", func(t *testing.T) {
		...
		case !errors.Is(err, gerror.ErrConversion):
			t.Errorf("the returned error is the expected error convertion error : %v", err)
		}
	})
...
func Test_Partial_Int(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.Int(path, 456); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
		} else if check != value {
...
func Test_Partial_Float(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.Float(path, 456.789); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
		} else if check != value {
			t.Errorf("returned the unexpected value of (%v) when expecting : %v", check, value)
		}
	...
	t.Run("return default value if the path don't exists", func(t *testing.T) {
		...
		check, err := sut.Float("node", value)
		switch {
		case err != nil:
			t.Errorf("returned the unexpected error : %v", err)
		case check != value:
...
func Test_Partial_String(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.String(path, "default value"); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
		} else if check != value {
			t.Errorf("returned the unexpected value of (%v) when expecting : %v", check, value)
		}
	...
	t.Run("return conversion error if not storing an string", func(t *testing.T) {
		...
		check, err := sut.String(path, "default value")
		switch {
		case check != "":
			t.Errorf("returned the unexpected value : %v", check)
		case err == nil:
	...
	t.Run("return default value if the path don't exists", func(t *testing.T) {
		...
		check, err := sut.String("node", value)
		switch {
		case err != nil:
			t.Errorf("returned the unexpected error : %v", err)
		case check != value:
...
func Test_Partial_List(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.List(path, []interface{}{"default value"}); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
	...
	t.Run("return conversion error if not storing an list", func(t *testing.T) {
		...
		check, err := sut.List(path, []interface{}{"default value"})
		switch {
		case check != nil:
			t.Errorf("returned the unexpected value : %v", check)
		case err == nil:
...
func Test_Partial_Partial(t *testing.T) {
	t.Run("return valid stored value", func(t *testing.T) {
		...
		if check, err := sut.Partial(path, Partial{"id": "default value"}); err != nil {
			t.Errorf("returned the unexpected error : %v", err)
		} else if !reflect.DeepEqual(check, value) {
			t.Errorf("returned the unexpected value of (%v) when expecting : %v", check, value)
		}
	...
	t.Run("return conversion error if not storing an Partial", func(t *testing.T) {
		...
		check, err := sut.Partial(path, Partial{"id": "default value"})
		switch {
		case check != nil:
			t.Errorf("returned the unexpected value : %v", check)
		case err == nil:
	...
	t.Run("return default value if the path don't exists", func(t *testing.T) {
		...
		check, err := sut.Partial("node", value)
		switch {
		case err != nil:
			t.Errorf("returned the unexpected error : %v", err)
		case !reflect.DeepEqual(check, value):
