...
func Test_NewLoader(t *testing.T) {
	...
	t.Run("nil cfg", func(t *testing.T) {
		...
		case !errors.Is(err, gerror.ErrNilPointer):
			t.Errorf("returned (%v) error when expecting (%v)", err, gerror.ErrNilPointer)
		}
	})
...
func Test_Loader_Load(t *testing.T) {
	...
	t.Run("error storing the base source", func(t *testing.T) {
		...
		if err := load.Load(); err == nil {
			t.Error("didn't returned the expected error")
		} else if !errors.Is(err, gerror.ErrDuplicateConfigSource) {
			t.Errorf("returned (%v) error when expecting (%v)", err, gerror.ErrDuplicateConfigSource)
		}
	})
	...
	t.Run("error on loaded missing id", func(t *testing.T) {
		...
		if err := load.Load(); err == nil {
			t.Error("didn't returned the expected error")
		} else if !errors.Is(err, gerror.ErrConfigPathNotFound) {
			t.Errorf("returned (%v) error when expecting (%v)", err, gerror.ErrConfigPathNotFound)
		}
	})
	...
	t.Run("error on loaded invalid id", func(t *testing.T) {
		...
		if err := load.Load(); err == nil {
			...
			t.Errorf("returned (%v) error when expecting (%v)", err, gerror.ErrConversion)
		}
	})
	...
	t.Run("error on loaded source factory", func(t *testing.T) {
		...
		if err := load.Load(); err == nil {
			t.Error("didn't returned the expected error")
		} else if !errors.Is(err, gerror.ErrInvalidConfigSourcePartial) {
			t.Errorf("returned (%v) error when expecting (%v)", err, gerror.ErrInvalidConfigSourcePartial)
		}
	})
