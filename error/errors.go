...
var (
	...
	// requested slate stream to be registered have an id of an already
	// registered slate stream.
	...
	// given slate stream configuration was unable to be parsed correctly
	// enabling the slate stream generation.
