...
func Test_Bool(t *testing.T) {
	...
	t.Run("no env value", func(t *testing.T) {
		value := ""
		cur := os.Getenv(env)
	...
	t.Run("env value with the string 'true'", func(t *testing.T) {
		value := "true"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
	...
	t.Run("env value with the string '1'", func(t *testing.T) {
		value := "1"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
...
func Test_Int(t *testing.T) {
	...
	t.Run("env value with an invalid string", func(t *testing.T) {
		value := "abc"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
	...
	t.Run("env value with a valid string", func(t *testing.T) {
		value := "456"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
...
func Test_String(t *testing.T) {
	...
	t.Run("env value with a string", func(t *testing.T) {
		value := "env string"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
...
func Test_List(t *testing.T) {
	...
	t.Run("env value with a single string", func(t *testing.T) {
		value := "string"
		cur := os.Getenv(env)
		_ = os.Setenv(env, value)
		defer func() { _ = os.Setenv(env, cur) }()
	...
	t.Run("env value with multi strings", func(t *testing.T) {
		value1 := "string1"
		value2 := "string2"
