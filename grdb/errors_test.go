...
func Test_ErrDatabaseConfigNotFound(t *testing.T) {
	t.Run("creation", func(t *testing.T) {
		...
		if err := errDatabaseConfigNotFound(arg); !errors.Is(err, gerror.ErrDatabaseConfigNotFound) {
...
func Test_ErrUnknownDatabaseDialect(t *testing.T) {
	t.Run("creation", func(t *testing.T) {
		...
		if err := errUnknownDatabaseDialect(arg); !errors.Is(err, gerror.ErrUnknownDatabaseDialect) {
