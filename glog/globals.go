...
var (
	...
	LoaderObserveConfig = genv.Bool(
		"SLATE_GLOG_LOADER_OBSERVE_CONFIG",
		true)

	// LoaderErrorChannel defines the loader error logging channel.
	LoaderErrorChannel = genv.String(
		"SLATE_GLOG_LOADER_ERROR_CHANNEL",
		"exec")
)
