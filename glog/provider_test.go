...
func Test_Provider_Register(t *testing.T) {
	...
	t.Run("error retrieving file system on retrieving the stream factory strategy file", func(t *testing.T) {
		...
		container := slate.ServiceContainer{}
		_ = (Provider{}).Register(container)
		_ = container.Service(gfs.ContainerID, func() (interface{}, error) {
			return nil, expected
		})
...
func Test_Provider_Boot(t *testing.T) {
	...
	t.Run("invalid log entry config", func(t *testing.T) {
		...
		source.EXPECT().Get("").Return(gconfig.Partial{"log": gconfig.Partial{"streams": "string"}}, nil).Times(1)
	...
	t.Run("correct boot", func(t *testing.T) {
		...
		_ = provider.Register(container)
		source := NewMockConfigSource(ctrl)
		source.EXPECT().Get("").Return(gconfig.Partial{"path": []interface{}{}}, nil).Times(1)
		cfg := gconfig.NewConfig(0)
		_ = cfg.AddSource("id", 0, source)
		_ = container.Service(gconfig.ContainerID, func() (interface{}, error) {
			return cfg, nil
