...
// Package mock_gconfig is a generated GoMock package.
package glog
...
var _ gconfig.Config = &MockConfig{}
...
func (m *MockConfig) Partial(path string, def ...gconfig.Partial) (gconfig.Partial, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{path}
	for _, a := range def {
		varargs = append(varargs, a)
