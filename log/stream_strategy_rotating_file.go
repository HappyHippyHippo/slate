...
// instance.
func (s streamStrategyRotatingFile) AcceptFromConfig(cfg config.IConfig) bool {
	if cfg == nil {
		return false
	}
...
func (s streamStrategyRotatingFile) CreateFromConfig(cfg config.IConfig) (IStream, error) {
	if cfg == nil {
