...
func Test_StreamFactory_Create(t *testing.T) {
	t.Run("unrecognized stream type", func(t *testing.T) {
		...
		case e == nil:
			t.Error("didn't returned the expected error")
		case !errors.Is(e, err.ErrInvalidLogStreamType):
			t.Errorf("returned the (%v) error when expecting (%v)", e, err.ErrInvalidLogStreamType)
		}
	})
...
func Test_StreamFactory_CreateFromConfig(t *testing.T) {
	...
	t.Run("unrecognized stream type", func(t *testing.T) {
		...
		case e == nil:
			t.Error("didn't returned the expected error")
		case !errors.Is(e, err.ErrInvalidLogStreamConfig):
			t.Errorf("returned the (%v) error when expecting (%v)", e, err.ErrInvalidLogStreamConfig)
		}
	})
