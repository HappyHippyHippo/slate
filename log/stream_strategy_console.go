...
import "github.com/happyhippyhippo/slate/config"
...
func newStreamStrategyConsole(fFactory IFormatterFactory) (IStreamStrategy, error) {
	if fFactory == nil {
...
// instance.
func (s streamStrategyConsole) AcceptFromConfig(cfg config.IConfig) bool {
	if cfg == nil {
		return false
	}
...
func (s streamStrategyConsole) CreateFromConfig(cfg config.IConfig) (IStream, error) {
	if cfg == nil {
