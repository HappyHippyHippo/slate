...
func GetFormatterFactory(c slate.ServiceContainer) (IFormatterFactory, error) {
	...
	if !ok {
		return nil, errConversion(instance, "log.IFormatterFactory")
	}
	return i, nil
}
...
func GetFormatterStrategies(c slate.ServiceContainer) ([]IFormatterStrategy, error) {
	...
	for _, service := range tags {
		...
		if !ok {
			return nil, errConversion(service, "log.IFormatterStrategy")
		}
		list = append(list, s)
	}
	return list, nil
...
func GetStreamFactory(c slate.ServiceContainer) (IStreamFactory, error) {
	...
	if !ok {
		return nil, errConversion(instance, "log.IStreamFactory")
	}
	return i, nil
}
...
func GetStreamStrategies(c slate.ServiceContainer) ([]IStreamStrategy, error) {
	...
	for _, service := range tags {
		...
		if !ok {
			return nil, errConversion(service, "log.IStreamStrategy")
		}
		list = append(list, s)
	}
	return list, nil
...
func Get(c slate.ServiceContainer) (ILogger, error) {
	...
	if !ok {
		return nil, errConversion(instance, "log.ILogger")
	}
	return i, nil
}
...
func GetLoader(c slate.ServiceContainer) (ILoader, error) {
	...
	if !ok {
		return nil, errConversion(instance, "log.ILoader")
	}
	return i, nil
}
