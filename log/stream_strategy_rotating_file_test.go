...
func Test_StreamStrategyFileRotate_Create(t *testing.T) {
	...
	t.Run("error on creating the formatter", func(t *testing.T) {
		...
		sut, _ := newStreamStrategyRotatingFile(NewMockFs(ctrl), formatterFactory)
	...
	t.Run("error on opening the file", func(t *testing.T) {
		...
		sut, _ := newStreamStrategyRotatingFile(fileSystem, formatterFactory)
...
func Test_StreamStrategyFileRotate_CreateFromConfig(t *testing.T) {
	...
	t.Run("error on creating the formatter", func(t *testing.T) {
		...
		formatterFactory := NewMockFormatterFactory(ctrl)
		formatterFactory.EXPECT().Create(FormatUnknown).Return(nil, expected).Times(1)
