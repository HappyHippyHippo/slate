...
// RotatingFileWriter defines an output writer used by a file stream that will
...
// NewRotatingFileWriter generate a new rotating file writer instance.
func NewRotatingFileWriter(
	...
	writer := &RotatingFileWriter{fs: fs, file: file}
...
func (w *RotatingFileWriter) Write(
	output []byte,
) (int, error) {
...
func (w *RotatingFileWriter) checkRotation() error {
