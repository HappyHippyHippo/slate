...
// streamConsole defines a file output logger stream.
...
// NewStreamConsole instantiate a new console stream object that will write
// logging content into the standard output.
