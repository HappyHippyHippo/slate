...
func NewSourceObservableRest(client HTTPClient, uri, format string, decoderFactory IDecoderFactory, timestampPath, configPath string) (ISourceObservable, error) {
	if client == nil {
