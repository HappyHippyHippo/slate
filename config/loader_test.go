...
func Test_NewLoader(t *testing.T) {
	t.Run("nil cfg", func(t *testing.T) {
		...
		case !errors.Is(e, err.ErrNilPointer):
			t.Errorf("returned (%v) error when expecting (%v)", e, err.ErrNilPointer)
		}
	})
...
func Test_Loader_Load(t *testing.T) {
	...
	t.Run("error on loaded missing id", func(t *testing.T) {
		...
		if e := sut.Load(); e == nil {
			t.Error("didn't returned the expected error")
		} else if !errors.Is(e, err.ErrConfigPathNotFound) {
			t.Errorf("returned (%v) error when expecting (%v)", e, err.ErrConfigPathNotFound)
		}
	})
	...
	t.Run("error on loaded invalid id", func(t *testing.T) {
		...
		if e := sut.Load(); e == nil {
			...
			t.Errorf("returned (%v) error when expecting (%v)", e, err.ErrConversion)
		}
	})
