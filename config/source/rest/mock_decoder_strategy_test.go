...
// MockDecoderStrategy is a mock instance of DecoderStrategy interface
type MockDecoderStrategy struct {
	ctrl     *gomock.Controller
	recorder *MockDecoderStrategyRecorder
}

var _ config.DecoderStrategy = &MockDecoderStrategy{}
...
func (m *MockDecoderStrategy) Create(args ...interface{}) (config.Decoder, error) {
	m.ctrl.T.Helper()
