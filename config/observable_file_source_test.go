...
func Test_NewObservableFileSource(t *testing.T) {
	t.Run("nil file system adapter", func(t *testing.T) {
		...
		sut, e := NewObservableFileSource("path", FormatYAML, nil, NewMockDecoderFactory(ctrl))
		switch {
		case sut != nil:
	...
	t.Run("nil decoder factory", func(t *testing.T) {
		...
		sut, e := NewObservableFileSource("path", FormatYAML, NewMockFs(ctrl), nil)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
	...
	t.Run("error that may be raised when retrieving the file info", func(t *testing.T) {
		...
		sut, e := NewObservableFileSource(path, FormatYAML, fs, decoderFactory)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
	...
	t.Run("error that may be raised when creating the decoder", func(t *testing.T) {
		...
		sut, e := NewObservableFileSource(path, FormatUnknown, fs, decoderFactory)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
...
func Test_ObservableFileSource_Reload(t *testing.T) {
	t.Run("error if fail to retrieving the file info", func(t *testing.T) {
		...
		sut, _ := NewObservableFileSource(path, FormatYAML, fs, decoderFactory)
	...
	t.Run("should reload a changed source", func(t *testing.T) {
		...
		case e != nil:
			t.Errorf("returned the (%v) error", e)
		case !reflect.DeepEqual(expected, sut.partial):
