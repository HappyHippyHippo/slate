...
func Test_NewFileSource(t *testing.T) {
	t.Run("nil file system adapter", func(t *testing.T) {
		...
		sut, e := NewFileSource("path", DecoderFormatYAML, nil, NewMockDecoderFactory(ctrl))
		switch {
		case sut != nil:
	...
	t.Run("nil decoder factory", func(t *testing.T) {
		...
		sut, e := NewFileSource("path", DecoderFormatYAML, NewMockFs(ctrl), nil)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
	...
	t.Run("error that may be raised when opening the file", func(t *testing.T) {
		...
		sut, e := NewFileSource(path, DecoderFormatYAML, fs, NewMockDecoderFactory(ctrl))
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
	...
	t.Run("error that may be raised when creating the decoder", func(t *testing.T) {
		...
		sut, e := NewFileSource(path, DecoderFormatUnknown, fs, decoderFactory)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
	...
	t.Run("error that may be raised when running the decoder", func(t *testing.T) {
		...
		sut, e := NewFileSource(path, DecoderFormatYAML, fs, decoderFactory)
		switch {
		case sut != nil:
			t.Error("returned a valid reference")
		case e == nil:
