...
func Test_NewSourceStrategyRest(t *testing.T) {
	...
	t.Run("new rest source dFactory strategy", func(t *testing.T) {
		...
		sut, e := newSourceStrategyRest(dFactory)
		switch {
		case e != nil:
			t.Errorf("returned the (%v) error", e)
		case sut == nil:
			t.Error("didn't returned a valid reference")
		case sut.(*sourceStrategyRest).dFactory != dFactory:
			t.Error("didn't stored the decoder dFactory reference")
		default:
			client := sut.(*sourceStrategyRest).cFactory()
			switch client.(type) {
			case *http.Client:
			default:
...
func Test_SourceStrategyRest_Create(t *testing.T) {
	...
	t.Run("create the rest source", func(t *testing.T) {
		...
		sut, _ := newSourceStrategyRest(dFactory)
		...
		sut.(*sourceStrategyRest).cFactory = func() HTTPClient {
			return client
		}
