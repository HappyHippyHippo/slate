...
func GetDecoderFactory(c slate.ServiceContainer) (IDecoderFactory, error) {
	...
	if !ok {
		return nil, errConversion(instance, "config.IDecoderFactory")
	}
	return i, nil
}
...
func GetDecoderStrategies(c slate.ServiceContainer) ([]IDecoderStrategy, error) {
	...
	for _, service := range tags {
		...
		if !ok {
			return nil, errConversion(service, "config.IDecoderStrategy")
		}
		list = append(list, s)
	}
	return list, nil
...
func GetSourceFactory(c slate.ServiceContainer) (ISourceFactory, error) {
	...
	if !ok {
		return nil, errConversion(instance, "config.ISourceFactory")
	}
	return i, nil
}
...
func GetSourceStrategies(c slate.ServiceContainer) ([]ISourceStrategy, error) {
	...
	for _, service := range tags {
		...
		if !ok {
			return nil, errConversion(service, "config.ISourceStrategy")
		}
		list = append(list, s)
	}
	return list, nil
...
func GetSourceContainerPartials(c slate.ServiceContainer) ([]IConfig, error) {
	...
	for _, service := range tags {
		...
		if !ok {
			return nil, errConversion(service, "config.IConfig")
		}
		list = append(list, s)
	}
	return list, nil
...
func Get(c slate.ServiceContainer) (IManager, error) {
	...
	if !ok {
		return nil, errConversion(instance, "config.IManager")
	}
	return i, nil
}
...
func GetLoader(c slate.ServiceContainer) (ILoader, error) {
	...
	if !ok {
		return nil, errConversion(instance, "config.ILoader")
	}
	return i, nil
}
